...
module sra(x,y,shift,cout,carry,overflow,zero);
input [63:0] x;
input [63:0] shift;
output [63:0] y;
output carry;
...
for(i = 0; i<64; i=i+1) begin: loop2
    if(i == 63) begin
        mux_2x1 d0(x[i],x[63],s[0],inter1[i]);
    end else begin
...
for(i = 0; i<64; i=i+1) begin: loop3
    if(i > 61) begin
        mux_2x1 d0(inter1[i],x[63],s[1],inter2[i]);
    end else begin
...
for(i = 0; i<64; i=i+1) begin: loop4
    if(i > 59) begin
        mux_2x1 d0(inter2[i],x[63],s[2],inter3[i]);
    end else begin
...
for(i = 0; i<64; i=i+1) begin: loop5
    if(i >55) begin
        mux_2x1 d0(inter3[i],x[63],s[3],inter4[i]);
    end else begin
...
for(i = 0; i<64; i=i+1) begin: loop6
    if(i > 47) begin
        mux_2x1 d0(inter4[i],x[63],s[4],inter5[i]);
    end else begin
...
for(i = 0; i<64; i=i+1) begin: loop7
    if(i > 31) begin
        mux_2x1 d0(inter5[i],x[63],s[5],y[i]);
    end else begin
